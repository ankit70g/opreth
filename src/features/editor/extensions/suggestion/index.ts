...
const suggestionState = StateField.define<string | null>({
    ...
    update(value, transaction) {
        ...
        // Otherwise, keep the current value unchanges
...
// WidgeType: Creates custom DOM elements to display in the editor.
...
const renderPlugin = ViewPlugin.fromClass(
    class {
        ...
        update(update: ViewUpdate) {
            ...
            // Rebuild decorations if doc changed, cursor oved, or suggestion changed
            const shouldRebuild =
...
const acceptSuggestionKeymap = keymap.of([
    {
        ...
        run: (view) => {
            ...
            return true; //We handled Tab, dont indent
        }
    }
]);
